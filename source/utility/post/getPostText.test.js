...
describe('getPostText', () => {
	...
	it('should skip autogenerated quotes when "skipGeneratedPostQuotes" is "true"', () => {
		getPostTextTest(
			{
				content:
				[
			...
			{
				skipGeneratedPostQuotes: true
			},
			'Abc'
		)
	})

	it('should not skip non-autogenerated quotes when "skipGeneratedPostQuotes" is "true"', () => {
		getPostTextTest(
			{
				content:
				[
