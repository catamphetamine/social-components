 ...
 * @param  {object} post
 * @param  {function} [options.onPostContentChange] — Is supposed to trigger a re-render of a linked `post` when its content has been modified. For example, when a parent post's content changed and the child post has an autogenerated quote of the parent post.
 * @param  {function} [options.getYouTubeVideoByUrl] — Can be used for getting YouTube videos by URL from cache.
 * @param  {(string|string[])} [options.youTubeApiKey] — YouTube API key.
 * @param  {function} [options.onContentChange] — re-renders the post after it has been updated.
