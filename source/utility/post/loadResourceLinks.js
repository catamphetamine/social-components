 ...
 * @param  {function} [options.onPostContentChange] — Is called on some other (related, "linked") post content change. For example, it may trigger a re-render of a linked `post` when its content has been modified. Say, when a parent post's content changed and the child post has an autogenerated quote of the parent post.
